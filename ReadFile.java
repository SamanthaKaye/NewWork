...
public class ReadFile {
	...
	public static List<Double> calculateDiscounts(List<String> lines) {
		...
		String itemCode, thisItem = " ", tempPrice = " ", currentInvoice, currentString, currentLine, previousInvoice;
		boolean isDiscount = false, commissionDrop, match; int discountCount = 0, index = 0;
			...
			for(int i = 0; i < itemsArray.length; i++) {
				...
				for(int b = 0; b < 1; b++) {
					...
					if(itemCode.contains("-L1")){thisItem = "L1"; compensation = 0.08; tempPrice = priceArray[a];  }											
					else if(itemCode.contains("-L2")){ thisItem = "L2"; compensation = .10; tempPrice = priceArray[a];  }
					else if(itemCode.contains("-L3")){ thisItem = "L3"; compensation = .13; tempPrice = priceArray[a];  }
					else if(itemCode.contains("-L4")){ thisItem = "L4"; compensation = .13; tempPrice = priceArray[a];  }
					else if(itemCode.contains("-L5")){ thisItem = "L5"; compensation = .13; tempPrice = priceArray[a];  }
					else if(itemCode.contains("T"))  {thisItem = "Regular"; compensation = .20; }
					else if(itemCode.contains("FWS")) {thisItem = "Regular"; compensation = .20; }
					else if(itemCode.contains("DIG")) {thisItem = "Regular"; compensation = .20; }
					...
					else { System.out.println("match = false " + tempPrice );}
					...
					System.out.println("Commissionable: " );
